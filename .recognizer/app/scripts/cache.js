...
var __recognizer804115264 = (function () {
    'use strict';
...
function Cache(options) {
    __recognizer804115264.logEntry([
        8,
        9,
        8,
        14
    ], arguments);
    this.id = __recognizer804115264.logProbe([
        9,
        20,
        9,
        28
    ], __recognizer804115264.logProbe([
        9,
        14,
        9,
        19
    ], Cache)._CacheId)++;
    this._options = __recognizer804115264.logProbe([
        10,
        20,
        10,
        27
    ], options) ? __recognizer804115264.logProbe([
        10,
        30,
        10,
        37
    ], options) : {};
    this._Cache = __recognizer804115264.logProbe([
        11,
        32,
        11,
        36
        ...
        11,
        22
    ], this)._options).data) ? __recognizer804115264.logProbe([
        11,
        53,
        11,
        57
    ...
    if (__recognizer804115264.logProbe([
            12,
            21,
            12,
            25
        ...
        delete __recognizer804115264.logProbe([
            12,
            48,
            12,
            52
    ...
    if (__recognizer804115264.logProbe([
        ...
        (function () {
            var obj = __recognizer804115264.logProbe([
                    14,
                    8,
                    14,
                    15
                ], options), fn = __recognizer804115264.logProbe([
                    14,
                    16,
                    14,
                    24
        ...
        }.bind(this)(__recognizer804115264.logProbe([
            14,
            25,
            14,
            29
...
Cache.prototype.get = function (key, callback) {
    ...
    if (!__recognizer804115264.logProbe([
        ...
        return __recognizer804115264.logProbe([
            24,
            25,
            24,
            31
    ...
    if (__recognizer804115264.logProbe([
        ...
        callback = __recognizer804115264.logProbe([
            26,
            52,
            26,
            57
    ...
    if (__recognizer804115264.logProbe([
        ...
        __recognizer804115264.logProbe([
            ...
            27,
            30
        ], this), __recognizer804115264.logProbe([
            27,
            32,
            27,
            35
...
Cache.prototype.set = function (key, value, callback) {
    ...
    if (!__recognizer804115264.logProbe([
        ...
        this._Cache[key] = __recognizer804115264.logProbe([
            39,
            29,
            39,
            34
...
Cache.prototype.stringify = function (key) {
    ...
    var tostrobj = __recognizer804115264.logProbe([
            65,
            19,
            65,
            22
        ], key) ? __recognizer804115264.logProbe([
            65,
            37,
            65,
            40
    ...
    return function () {
        var obj = __recognizer804115264.logProbe([
                ...
                66,
                19
            ], LZString), fn = __recognizer804115264.logProbe([
                66,
                20,
                66,
                36
            ], obj.compressToBase64);
        return fn.apply(obj, arguments);
    }.bind(this)(function () {
        var obj = __recognizer804115264.logProbe([
                66,
                ...
                66,
                41
            ], JSON), fn = __recognizer804115264.logProbe([
                66,
                42,
                66,
                51
...
Cache.prototype.parse = function (key, val) {
    ...
    var valObj = function () {
            ...
            76,
            61
        ], val) ? __recognizer804115264.logProbe([
            76,
            64,
            76,
            67
